...
hh_api_token = 'APPLV5365FJGH3926CRP2M8H3214JAA1DO2L4E6HVUHDL2UR77M96ILSI48453TA'
...
def create_table(conn):
    ...
    create_table_query = """
        CREATE TABLE IF NOT EXISTS vacancies_v2 (
    ...
    conn.commit()
    cursor.close()
    logging.info("Таблица 'vacancies_v2' успешно создана.")
